export class ChartDB {
  ...
  public static bar2CAC = {
    ...
    colors: ['#254676', '#0e9e4a', '#ffa21d', '#ff5252'],
    responsive: [{
      breakpoint: 480,
      options: {
        legend: {
  ...
  public static bar4CAC = {
    ...
    colors: ['#254676', '#00acc1', '#0e9e4a', '#ffa21d', '#ff5252'],
    stroke: {
      width: 1,
      colors: ['#fff']
    },
  ...
  public static scatter1CAC = {
    ...
    colors: ['#254676', '#0e9e4a', '#ff5252', '#ffa21d', '#00acc1'],
    series: [{
      name: 'SAMPLE A',
      data: [
        [16.4, 5.4],
  ...
  public static pie1CAC = {
    ...
    colors: ['#254676', '#0e9e4a', '#00acc1', '#ffa21d', '#ff5252'],
    legend: {
      show: true,
      position: 'bottom',
    },
